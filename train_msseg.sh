...
nohup python main.py -d /home/mayang/data/MSSEG2016 -o /home/mayang/data/output/MSSEG2016 -t msseg -m metrics.csv --run_cross_train --dropout 0 --epochs 20 --patience 5 &
