...
nohup python main.py -d /home/mayang/data/MSSEG2016 -o /home/mayang/data/output/MSSEG2016 -t msseg --run-train --dropout 0.5 --epochs 20 --patience 5 --filters 32/64/128/256 &
